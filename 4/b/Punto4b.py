...
class Punto4b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Punto4b")
        ...
        self._Am_range = Range(0, 5, 0.000001, 1, 200)
...
def main(top_block_cls=Punto4b, options=None):
