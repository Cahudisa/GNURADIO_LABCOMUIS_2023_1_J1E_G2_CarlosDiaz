...
class moduladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "frecuencia de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "nivel de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._A_range = Range(-10, 10, 0.1, 2, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fs, A, (DC-A/2), 0)
    ...
    def set_DC(self, DC):
        self.DC = DC
        self.analog_sig_source_x_0_0.set_offset((self.DC-self.A/2))
